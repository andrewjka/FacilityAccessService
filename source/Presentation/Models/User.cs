...
public class User : IEquatable<User>
{
    ...
    public enum RoleEnum
    {
        ...
        /// </summary>
        [EnumMember(Value = "guest")] GuestEnum = 1,

        /// <summary>
        ///     Enum EmployeeEnum for employee
        /// </summary>
        [EnumMember(Value = "employee")] EmployeeEnum = 2,

        /// <summary>
        ///     Enum GuardEnum for guard
        /// </summary>
        [EnumMember(Value = "guard")] GuardEnum = 3,

        /// <summary>
        ///     Enum AdministratorEnum for administrator
        /// </summary>
        [EnumMember(Value = "administrator")] AdministratorEnum = 4
    }
